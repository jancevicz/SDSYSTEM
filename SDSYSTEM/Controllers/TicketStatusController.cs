...
namespace SDSYSTEM.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StatusName")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StatusName")] TicketStatus ticketStatus)
        {
